...
<table className="border-2 w-full ">
{
                       ...
                       <td className="border-2  p-4  w-2/4 text-white">Avatar</td>
                       </tr> :<tr className=""> <td className="border-2  text-pink-500 text-2xl w-2/4  p-4   my-2">Name: </td>
                       <td className="border-2 w-2/4  p-4  text-white">Avatar</td>
                       </tr>
                     }
{
