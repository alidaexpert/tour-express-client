        ...
        <div className="py-8  bg-blue-900 bg-opacity-10">
            ...
            <div className=" grid lg:grid-cols-2 grid-cols-1">
                    ...
                    <div className="relative order-2 lg:order-1 sm:mb-8">
                        ...
                        <img src={tour2} className="w-2/4 border-4 hover:scale-110 transform transition-transform border-indigo-500 rounded-md absolute top-3/4 lg:left-3/4 left-1/2" alt="" />
                    </div>
