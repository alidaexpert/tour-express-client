...
import GalleryPhoto from '../../Home/GalleryPhoto/GalleryPhoto';

const GalleryPage = () => {
    const [gallery,setGallery]=useState([])
    useEffect(()=>{
        fetch("https://tour-express.herokuapp.com/gallery")
        .then(res=>res.json())
    ...
    return (
        <div>
           ...
           <h4 className="text-xl text-pink-500 font-medium my-2"> Our Tourist Gallery</h4>
